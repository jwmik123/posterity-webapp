  ...
  return (
    <div className="top-0 z-50">
      <nav
        className={
          colorChange
            ? "z-50 flex w-full bg-gray  items-center justify-between py-2 px-5 md:px-20 xl:px-48"
            : "z-50 flex w-full items-center  justify-between py-10 px-5 md:px-20 xl:px-48"
        }
      >
        <div
          className={
            colorChange
              ? " flex text-ketic font-staat text-2xl py-1 px-2 rounded h-18"
        ...
        >
          ...
          <div className="flex flex-row items-center">
            <svg
              ...
              viewBox="0 0 513.44 518.6"
            >
              <path
                d="M775.58,456.07c4.77-12.59,13.2-38.18,16.83-51.15a134.62,134.62,0,0,0,3.77-18.42c6.17-54.89-41.81-104.75-95.25-104.75l.17-.06-183.28-1L361,799.3h58.59l139-463.93.84-2.65,116.27-.47H681c30.66,0,57,24,55.5,53.5a84.55,84.55,0,0,1-1,9.93,316.31,316.31,0,0,1-11.83,38.81c-1,2.52-3.33,7.42-4.56,9.83-13.46,26.42-39.36,46-68.08,53.35a96.52,96.52,0,0,1-24.74,3l-4.42-.09-53.9-.16-18.13,50.8H624l4.85-.16c56.5.06,119.14-37.61,143.77-88C773.4,461.35,774.91,457.85,775.58,456.07Z"
                transform="translate(-283.28 -280.7)"
              />
              <polygon points="18.1 220.62 117.42 220.27 99.75 271.15 0 271.15 18.1 220.62" />
            </svg>
            <span>osterity.</span>
          </div>
        </div>
        <ul
          className={
            !colorChange
              ? "hidden lg:flex gap-10 items-center font-roboto text-gray"
              : "hidden lg:flex gap-10 items-center font-roboto text-ketic"
          }
        >
          <Link href="/">
            <li className="nav-item" data-aos="fade-in" data-aos-delay="100">
              Home
            </li>
          </Link>
          <li
          ...
          <Link href="#">
            <li
              className="nav-item text-slate-700 line-through cursor-not-allowed"
              data-aos="fade-in"
              data-aos-delay="300"
            >
              Gallery
          ...
          <ul
            className={
              !colorChange
                ? "flex divide-x divide-gray items-center"
                : "flex divide-x divide-ketic items-center"
            }
          >
            <li
              className={
            ...
            >
              <a
                ...
                rel="noreferrer"
              >
                <FaDiscord className="text-xl mx-5" />
              </a>
            </li>
            <li
              className={
            ...
            >
              <a
                ...
                rel="noreferrer"
              >
                <AiFillInstagram className="text-xl mx-5" />
              </a>
            </li>
            <li
              className="cursor-pointer text-gray px-5"
              data-aos="fade-in"
              data-aos-delay="800"
            >
              <svg
