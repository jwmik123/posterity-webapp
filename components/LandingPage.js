...
function LandingPage() {
  return (
    <div className="px-5 lg:px-48 h-[100vh] bg-gradient-to-b from-slate-900 via-slate-800 to-slate-700 font-poppins flex items-center relative text-slate-100">
      <div className="z-10 relative w-1/2 flex flex-col">
      <h1 className="text-6xl md:text-[220px] font-bebas" data-aos="fade-up"  data-aos-delay="400">Posterity Watches</h1>
