  ...
  return (
    <div className="roadmap pt-24 -mt-24 mx-5 md:mx-10 md:px-10 lg:mx-24 lg:px-24 md:pb-20 lg:pb-0">
      ...
      <h4 className="text-xl text-gray mb-5 text-center" data-aos="fade-up">
        ...
        brand in the metaverse combined with an engaging and involved community.
      </h4>

      <div className="grid-container w-full flex justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative text-gray">
          <div className="border-b-2 py-10 px-5" data-aos="fade-right" data-aos-delay="500">
    ...
    //       <Suspense fallback={<p>loading</p>}>
    //         <Spline scene="https://prod.spline.design/sTKGGd5CJ3H73rsn/scene.spline" />
