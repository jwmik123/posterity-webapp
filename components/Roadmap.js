...
const Roadmap = () => {
  return (
    <div className="roadmap pt-24 -mt-24 mx-5 md:mx-10 md:px-10 xl:mx-24 xl:px-24 md:pb-20 lg:pb-0">
      ...
      <div className="grid-container w-full flex justify-center">
        <div className="grid grid-cols-1 md:grid-cols-2 pt-8 gap-10 relative text-gray">
          <div 
            className="py-10 px-5 border-b-2"
            //data-aos={isMobile ? "fade-up" : "fade-right"} data-aos-delay="500"
           >
